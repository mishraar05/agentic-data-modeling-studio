...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.control.source_dictionary_attribute (
...
ALTER TABLE insurance_source_discovery.control.source_dictionary_attribute ADD CONSTRAINT source_dictionary_attribute_lifecycle_state_check CHECK (lifecycle_state IN ('DRAFT', 'APPROVED', 'REJECTED', 'SUPERSEDED'));