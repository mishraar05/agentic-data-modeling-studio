...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.control.source_snapshot (
...
ALTER TABLE insurance_source_discovery.control.source_snapshot ADD CONSTRAINT source_snapshot_lifecycle_state_check CHECK (lifecycle_state IN ('COMMITTED', 'SUPERSEDED'));