...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.gw_pc_bronze.source_dictionary_relationship (
...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.source_dictionary_relationship ADD CONSTRAINT source_dictionary_relationship_lifecycle_state_check CHECK (lifecycle_state IN ('DRAFT', 'APPROVED', 'REJECTED', 'SUPERSEDED'));