...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.gw_pc_bronze.profile_evidence (
...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.profile_evidence ADD CONSTRAINT profile_evidence_lifecycle_state_check CHECK (lifecycle_state IN ('COMMITTED', 'SUPERSEDED'));