...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.gw_pc_bronze.review_item (
...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.review_item ADD CONSTRAINT review_item_lifecycle_state_check CHECK (lifecycle_state IN ('OPEN', 'RESOLVED', 'SUPERSEDED'));