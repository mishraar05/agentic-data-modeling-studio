...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.requirement_set ADD CONSTRAINT requirement_set_lifecycle_state_check CHECK (lifecycle_state IN ('COMMITTED', 'SUPERSEDED'));