...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.gw_pc_bronze.business_term (
...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.business_term ADD CONSTRAINT business_term_lifecycle_state_check CHECK (lifecycle_state IN ('DRAFT', 'APPROVED', 'REJECTED', 'SUPERSEDED'));