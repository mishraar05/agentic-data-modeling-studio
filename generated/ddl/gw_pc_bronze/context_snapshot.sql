...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.context_snapshot ADD CONSTRAINT context_snapshot_lifecycle_state_check CHECK (lifecycle_state IN ('COMMITTED', 'SUPERSEDED'));