...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.gw_pc_bronze.evidence_set (
...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.evidence_set ADD CONSTRAINT evidence_set_lifecycle_state_check CHECK (lifecycle_state IN ('COMMITTED', 'SUPERSEDED'));