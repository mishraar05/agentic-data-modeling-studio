...
CREATE TABLE IF NOT EXISTS insurance_source_discovery.gw_pc_bronze.document_set (
...
ALTER TABLE insurance_source_discovery.gw_pc_bronze.document_set ADD CONSTRAINT document_set_lifecycle_state_check CHECK (lifecycle_state IN ('COMMITTED', 'SUPERSEDED'));